...
- (MyLinearLayout *)createHorzSubviewLayout {
    ...
    self.label1 = [self createLabel:NSLocalizedString(@"top margin", @"") backgroundColor:[CFTool color:5]];
    self.label1.myTop = 10; //上边边距10
    self.label1.myLeading = 10; //左边间距10
    self.label1.myWidth = 60;
    self.label1.myHeight = 60;
    [horzLayout addSubview:self.label1];


    self.label2 = [self createLabel:NSLocalizedString(@"vert center", @"") backgroundColor:[CFTool color:6]];
//    self.label2.myLeading = 10;
    self.label2.myCenterY = 0; //垂直居中，如果不等于0则会产生居中偏移
    self.label2.mySize = CGSizeMake(60, 60);
    [horzLayout addSubview:self.label2];


    self.label3 = [self createLabel:NSLocalizedString(@"bottom margin", @"") backgroundColor:[CFTool color:7]];
//    self.label3.myBottom = 10; //下边边距10
//    self.label3.myLeading = 10;
//    self.label3.myTrailing = 5;
    self.label3.frame = CGRectMake(0, 0, 60, 60);
    [horzLayout addSubview:self.label3];


    self.label4 = [self createLabel:NSLocalizedString(@"top bottom", @"") backgroundColor:[CFTool color:8]];
//    self.label4.myTop = 10;
//    self.label4.myBottom = 10; //上面两行代码将上下边距设置为10,对于水平线性布局来说如果子视图同时设置了上下边距则高度会自动算出,因此不需要设置myHeight的值了。
//    self.label4.myLeading = 10;
//    self.label4.myTrailing = 10;
    self.label4.myWidth = 60;
    self.label4.myHeight = 60;
    [horzLayout addSubview:self.label4];
...
- (void)tapLabel:(UITapGestureRecognizer *)gestureRecognizer {
